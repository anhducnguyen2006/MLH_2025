export default function FooterPage() {
    return(
        <div>
            <footer className="d-flex align-items-center justify-content-center bg-[#d1aa79] text-white pt-4 ">
                    <div className="container d-flex flex-column align-items-center text-center">
                    

                    {/* Copyright */}
                    <small>Copyright © 2025 ACM at Gettysburg. All Rights Reserved.</small>
